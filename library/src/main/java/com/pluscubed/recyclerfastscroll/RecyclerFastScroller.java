...
public class RecyclerFastScroller extends FrameLayout {
    ...
    private void updateHandleColorsAndInset() {
        ...
        PaintDrawable normalDrawable = new PaintDrawable(mHandleNormalColor);
        PaintDrawable pressedDrawable = new PaintDrawable(mHandlePressedColor);
        normalDrawable.setCornerRadius(Integer.MAX_VALUE);
        pressedDrawable.setCornerRadius(Integer.MAX_VALUE);
        ...
        RecyclerFastScrollerUtils.setViewBackground(mHandle, stateListDrawable);
    }

    private void updateBarColorAndInset() {
        PaintDrawable barDrawable = new PaintDrawable(mBarColor);
        barDrawable.setCornerRadius(Integer.MAX_VALUE);
        InsetDrawable insetDrawable = !RecyclerFastScrollerUtils.isRTL(getContext())
                ? new InsetDrawable(barDrawable, mBarInset, 0, 0, 0)
                : new InsetDrawable(barDrawable, 0, 0, mBarInset, 0);
        insetDrawable.setAlpha(57);
        RecyclerFastScrollerUtils.setViewBackground(mBar, insetDrawable);
    }
